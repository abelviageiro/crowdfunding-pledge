	...
	public function flash($key = 'flash', $attrs = array()) {
		...
		if (CakeSession::check('Message.' . $key)) {
			...
			if ($flash['element'] == 'default') {
				$class = 'message pr no-mar';
				if (!empty($flash['params']['class'])) {
					$class = $flash['params']['class'];
				}
				if ($key == 'success') {
					$out = '<div class="alert alert-success"><a href="#" class="close js-no-pjax" data-dismiss="alert"  aria-label="close">&times;</a>' . $message . '</div>';
				} else if ($key == 'error') {
					$out = '<div class="alert alert-danger"><a href="#" class="close js-no-pjax" data-dismiss="alert"  aria-label="close">&times;</a>' . $message . '</div>';
				} else if ($key == 'flash') {
					$out = '<div class="alert alert-warning"><a href="#" class="close js-no-pjax" data-dismiss="alert"  aria-label="close">&times;</a>' . $message . '</div>';
				} else {
					$out = '<div class="alert alert-info"><a href="#" class="close js-no-pjax" data-dismiss="alert"  aria-label="close">&times;</a>' . $message . '</div>';
				}
