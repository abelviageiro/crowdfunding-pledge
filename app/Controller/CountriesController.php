        ...
        if (!empty($this->request->params['named']['q'])) {
            $conditions[] = array(
                'OR' => array(
                    ...
                    array(
                        'Country.capital LIKE ' => '%' . $this->request->params['named']['q'] . '%'
                    ) ,
                    array(
                        'Country.currency LIKE ' => '%' . $this->request->params['named']['q'] . '%'
                    ) ,
                    array(
                        'Country.currencyname LIKE ' => '%' . $this->request->params['named']['q'] . '%'
                    )
                )
            );
