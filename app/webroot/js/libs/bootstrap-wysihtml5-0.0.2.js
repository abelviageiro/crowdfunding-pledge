!function($, wysi) {
    ...
    var templates = {
         "font-styles": "<li class='dropdown btn-toolbar'>" +
        ...
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
                               ...
                               "<a class='btn btn-default' data-wysihtml5-command='Outdent' title='Outdent'><i class='fa fa-align-right'></i></a>" +
                               "<a class='btn btn-default' data-wysihtml5-command='Indent' title='Indent'><i class='fa fa-align-left'></i></a>" +
                           "</div>" +
                       "</li>",
        "link":        "<li>" +
                           "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                               ...
                               "<div class='modal-footer'>" +
                                   ...
                                   "<a href='#' class='btn btn-default' data-dismiss='modal'>Insert link</a>" +
                               "</div>" +
                           "</div>" +
        ...
        "image":       "<li>" +
                           "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                               ...
                               "<div class='modal-footer'>" +
                                   "<a href='#' class='btn btn-default' data-dismiss='modal'>Cancel</a>" +
                                   "<a href='#' class='btn btn-default' data-dismiss='modal'>Insert image</a>" +
                               "</div>" +
                           "</div>" +
    ...
    Wysihtml5.prototype = {
        ...
        createToolbar: function(el, options) {
            var self = this;
            var toolbar = $("<ul/>", {
                'class' : "wysihtml5-toolbar span hor-smspace",
                'style': "display:none"
            });
        ...
        initInsertImage: function(toolbar) {
            ...
            var insertButton = insertImageModal.find('a.btn');
        ...
        initInsertLink: function(toolbar) {
            ...
            var insertButton = insertLinkModal.find('a.btn');
            var initialValue = urlInput.val();
