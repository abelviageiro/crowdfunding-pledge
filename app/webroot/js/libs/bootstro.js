...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            nextButton : '<button class="btn btn-primary btn-sm bootstro-next-btn">Next &raquo;</button>',
            prevButton : '<button class="btn btn-primary btn-sm bootstro-prev-btn">&laquo; Prev</button>',
            finishButton : '<button class="btn btn-sm btn-success bootstro-finish-btn"><i class="icon-ok"></i> Close</button>',
