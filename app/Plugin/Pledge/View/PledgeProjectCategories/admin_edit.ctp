...
<div class="projectCategories admin-form">
	...
	<fieldset>
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo sprintf(__l('Edit %s'), sprintf(__l('%s %s Category'), Configure::read('project.alt_name_for_pledge_singular_caps'), Configure::read('project.alt_name_for_project_singular_caps')));?></li>
		</ul>
