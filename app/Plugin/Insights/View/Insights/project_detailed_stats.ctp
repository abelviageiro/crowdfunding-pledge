...
<table class="table table-striped table-bordered table-condensed table-hover">
    <tr>
      <td class="text-right"><?php echo __l('Needed Amount');?></td>
      <td class="text-right"><?php echo $this->Html->cCurrency($project_stats['needed_amount']);?></td>
    </tr>
    <tr>
      <td class="text-right"><?php echo __l('Collected Amount');?></td>
      <td class="text-right"><?php echo $this->Html->cCurrency($project_stats['collected_amount']);?></td>
    </tr>
    <tr>
      <td class="text-right"><?php echo __l('Fund Count');?></td>
      <td class="text-right"><?php echo $this->Html->cInt($project_stats['fund_count'], false);?></td>
    </tr>
    <tr>
      <td class="text-right"><?php echo __l('Site Commission');?></td>
      <td class="text-right"><?php echo $this->Html->cCurrency($project_stats['site_commission']);?></td>
    </tr>
  </table>
</div>
 <?php
