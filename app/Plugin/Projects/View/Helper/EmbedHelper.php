...
class EmbedHelper extends AppHelper
{
     ...
     *           property of the embed to be returned.  If
    ...
    {
        return isset($property) ? $this->_embed[$property] : $this->_embed;
    }
    /**
    ...
    public function getobjParam($param, $value = null) 
    {
        if (!is_array($this->_object_params)) return false;
        $values = array();
        if (is_array($param)) {
    ...
    public function getObjectAttrib() 
    {
