...
<div class="clearfix">
  <div class="page-header"><h2><?php echo __l('Affiliate');?></h2></div>
  ...
  <div class="userCashWithdrawals index js-response js-withdrawal_responses js-responses">
    ...
    <table class="table table-striped table-bordered table-condensed table-hover">
      <tr>
        ...
        <th class="text-right"><?php echo $this->Paginator->sort('AffiliateCashWithdrawal.amount', __l('Requested Amount').' ('.Configure::read('site.currency').')');?></th>
      ...
      <tr>
        ...
        <td class="text-right"><?php echo $this->Html->cCurrency($userCashWithdrawal['AffiliateCashWithdrawal']['amount']);?></td>
      ...
      <tr>
        ...
        <p><?php echo sprintf(__l('No %s available'), __l('Affiliate Cash Withdrawals'));?></p>
        </div>
		</td>
      </tr>
      <?php endif; ?>
