<div class="js-ecommerce js-cache-load-admin-ecommerce_chart">
  <div class="accordion-group">
    <div class="accordion-heading bootstro" data-bootstro-step="2" data-bootstro-content="<?php echo __l(" Ecommerce represents the total transactions made in the selected period and transaction revenue for the site. It shows the pie chart representation for revenue gather by which source and pie chart representation for revenue gather by which project type either pledge, donate, equity or lend.");?>" data-bootstro-width="600px" data-bootstro-title="Ecommerce">
      <div class="no-bor clearfix box-head">
        <h5>
          ...
          <a class="accordion-toggle js-toggle-icon js-no-pjax clearfix pull-right" href="#ecommerce" data-parent="#accordion-admin-dashboard" data-toggle="collapse">
	  ...
	  <?php echo $this->element('chart-admin_ecommerce_transaction_chart', array('select_range_id' => $select_range_id, 'cache' => array('config' => 'site_element_cache_15_min'))); ?>
        ...
        <div class="row">
			...
			<h3><?php echo __l("E-Commerce Per Source"); ?></h3>
                ...
                <div class="text-center" id="ecommerce_chart" style="width: 450px; height: 400px;"></div>
              </section>
			  <section class="col-md-6 text-center">
                        ...
                        <script type="text/javascript">
                          ...
                          <?php } ?>
                           ...
                           <?php } ?>
																					...
																					<div class="text-center" id="ecommerce_chart_category" style="width: 450px; height: 400px;"></div>
              </section>
        </div>
      </div>
    </div>
