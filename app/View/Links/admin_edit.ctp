<div class="links admin-form">
	<ul class="breadcrumb">
		...
		<li class="active"><?php echo sprintf(__l('Edit %s'), __l('Link'));?></li>
	</ul>
	...
	<?php echo $this->Form->create('Link', array('class' => 'form-horizontal navbar-btn', 'url' => array('controller' => 'links', 'action' => 'edit', 'menu' => $menuId)));?>
	...
	<fieldset class="gray-bg admin-checkbox">
		<div class="tab-content" id="myTabContent">
			<div id="link-basic" class="tab-pane fade in active">
				...
				<div class="clearfix info">
					<?php echo $this->Html->link('<i class="fa fa-plus-circle fa-fw"></i>'.__l(' Link to a Node'), Router::url(array('controller' => 'nodes', 'action' => 'index', 'links' => 1), true), array('data-toggle' => 'modal', 'data-target' => '#js-ajax-modal','class'=>'','id'=>'', 'escape' => false, 'title' => __l(' Link to a Node'))); ?>
				</div>
		...
		<?php echo $this->Layout->adminTabs(); ?>
			<div class="form-actions">
				...
				<?php echo $this->Html->link(__l('Cancel'), array('action' => 'index', $menuId), array('title' => __l('Cancel'), 'class' => 'btn btn-danger', 'escape' => false)); ?>
			</div>
