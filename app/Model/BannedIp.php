...
class BannedIp extends AppModel
{
    ...
    function __construct($id = false, $table = null, $ds = null) 
    {
        ...
        $this->validate = array(
            ...
            'range' => array(
                'rule1' => array(
                    'rule' => '_isRangeRequired',
                    'message' => __l('Required')
                )
            ) ,
            'duration_time' => array(
                'rule1' => array(
                    'rule' => '_isDurationRequired',
    ...
    function _checkIsIpBanned($ip = null) 
    {
        $ip = ip2long($ip);
    ...
    function _checkRefererBlocked($url = null) 
    {
        if (!empty($url)) {
